          ...
          <div className="inline-block mb-2">
            <h1 className="text-6xl md:text-7xl font-black tracking-tighter leading-[0.9]">
              ...
              <span
                ...
                style={{ WebkitTextStroke: '2px #b9643b', marginLeft: 10 }}
              >
                US
              </span>
            </h1>
        ...
        <section className="mb-32 md:mb-20 relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-16 relative z-10">
            {[{
              ...
              <div
                key={idx}
                className={`group relative p-10 md:p-12  border border-black/60 bg-white/80 backdrop-blur-sm
...
`}
              >
                ...
                <div className="relative z-10 ">
                  ...
                  {/* Progress line */}
                  <div className="mt-8 relative h-[2px] w-full bg-[#b9643b]/20 overflow-hidden rounded-full">
